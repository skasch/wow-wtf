			...
			["realm"] = {
				...
				["La Croisade écarlate"] = {
					["history"] = {
						...
						"/i Bloodlust svp", -- [13]
						"/i merci =)", -- [14]
						"/i def les dfemolisseurs aussi ^^", -- [15]
						"/i gooo", -- [16]
						"/i Hello =)", -- [17]
						"/reload", -- [18]
						"/i Hello =)", -- [19]
						"/i bah ne l'utilise pas de suite", -- [20]
						"/i =)", -- [21]
						"/i Tu peux l'utiliser sur les 2 derniers a priori", -- [22]
						"/i Il disparait oui a priori", -- [23]
						"/i Mais tu es virtuellement intuable", -- [24]
						"/i tu peux y aller", -- [25]
						"/i ca dure 10min iirc", -- [26]
						"/i c'est possible", -- [27]
						"/invite", -- [28]
						"/wave", -- [29]
						"/tomtom", -- [30]
